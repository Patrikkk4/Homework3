...
namespace Homework3._1GameWithPC
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string Gamer1; // переменная для имени первого игрока
            string GamerPC; // переменная для имени второго игрока

            //int Gamer1Num, GamerPCNum; // переменные ввода первого и второго игроков

            Console.ForegroundColor = ConsoleColor.Gray; // Задание цвета выводимого текста

            Console.Write($"{"Введите имя первого игрока: ",63}"); //
            Gamer1 = Console.ReadLine();                   // Ввод имени первого игрока

            GamerPC = "Computer";                                           // 
            Console.Write($"{"Имя второго игрока: " + GamerPC,64}" + "\n"); // объявление имени компьютерного игрока
            ...
            // Метод вычисления разницы заданного числа и числа игрока
            ...
            while (gameNumber > 0) // Цикл игры
            {
                ...
                int NumPCgamer = NumPC.Next(1, 5);

                Console.Write("Ходит: " + GamerPC + "\nВведи число от 1 до 4\nТвое число: " + NumPCgamer + "\n"); // Вывод ходи "Computer"
                                              
                Turn(NumPCgamer, GamerPC);
                Console.WriteLine($"{ "новое число: " + gameNumber,56}" + "\n"); // вывод в консоль разницы случайного числа и числа первого игрока.   
            }
